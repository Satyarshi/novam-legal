          ...
          <tbody>
            {orderData.map((order, index) => (
              <tr key={index}>
                ...
                <td className="border-b border-[#eee] px-4 py-6 flex justify-center dark:border-strokedark">
                ...
                <td className="border-b border-[#eee] px-4 py-6 dark:border-strokedark flex justify-center">
                  <FiFileText className="h-5 w-5 text-gray-600" />
                </td>
              </tr>
            ))}
...
export default LawyerManagementTable;
