...
const menuGroups = [
  {
    ...
    menuItems: [
      {
        icon: (
          <img src="/images/sidebar/dashboard.svg" alt="dashboard" />
        ),
        label: "Dashboard",
        route: "/",
      ...
      {
        icon: (
          <img src="/images/sidebar/order_management.svg" alt="order_management" />
        ),
      ...
      {
        icon: (
          <img src="/images/sidebar/lead_manangement.svg" alt="lead_management" />
        ),
      ...
      {
        icon: (
          <img src="/images/sidebar/order_management.svg" alt="lawyer_management" />
        ),
      ...
      },
      {
        ...
        label: "Lawyer's Application",
        route: "/lawyer-application",
      },
      {
        icon: (
          <img src="/images/sidebar/payment.svg" alt="payment" />
        ),
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden border-r-2 dark:border-0 shadow-md bg-white duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex}>
                <h3 className="mb-4 ml-4 text-sm font-semibold text-[#4B5563] dark:text-bodydark1">
                  {group.name}
                </h3>
